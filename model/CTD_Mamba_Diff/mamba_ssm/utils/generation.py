...
from transformers.generation.utils import GenerateOutput as GenerateDecoderOnlyOutput


@dataclass
class InferenceParams:
    """Inference parameters that are passed to the main models in order
...
def update_graph_cache(
    ...
    if (
        ...
        assert hasattr(model, "allocate_inference_cache"), "CUDA graph decoding requires that the models has a method allocate_inference_cache"

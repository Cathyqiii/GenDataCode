...
def visualize_multiple_tsne(
    ...
    Args:
        ...
        model_name (str): Name of the VAE models to use.
    ...
    for i, dataset_name in enumerate(dataset_names):
        for j, perc in enumerate(perc_list):
            ...
            # Load data, train the models, and visualize t-SNE for the current dataset and percentage
            ...
            # Load VAE models and generate prior samples

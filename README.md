...
## 项目特性
支持主流工业/时序数据集：C-MAPSS (FD001/FD002/FD003/FD004)、ETTh1/ETTh2、北京/意大利空气质量、交通流量数据
基于Mamba架构优化长时序建模能力，结合条件扩散保证生成数据的可控性
内置数据质量评估（W距离、DTW、自相关性、可视化对比）
全流程自动化：训练→合成数据生成→效果评估
## 使用方法
1. 克隆本项目仓库
   ```bash

...
for tt in range(3):
    ...
    for DATASET in ['etth1', 'etth2','AirQuality(bj)','AirQuality(Italian)','Traffic','FD001']:
        ...
        optim = 'adam'
        DEVICE = 'cuda:0'
        MODEL = 'FEDformer'  # TimesNet, lstm-att, Informer, DLinear, MICN, PatchTST, LSTM,FEDformer
        gen_mode = 'CTD_Mamba_Diff'  # TimeGAN,TimeVAE,Diffusion-TS,PaD-TS-main,RL_WolfPHC_gen CTD_Mamba_Diff
